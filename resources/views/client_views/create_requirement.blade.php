        ...
        function optchange(select) {
            ...
            if(selected.id == 1)
            {
                document.getElementById("estateopt").innerHTML = `
                    ...
                    <p><input name="min_s" type="" placeholder="..."  value=""></p>
                    <p>Максимальная площадь</p>
                    <p><input name="max_s" type="text" placeholder="..."  value=""></p>
                    <p>Мин кол-во комнат</p>
                    <p><input name="min_count" type="text"  value=""/></p>
                    <p>Макс кол-во комнат</p>
                    <p><input name="max_count" type="text" placeholder="..."  value=""></p>
                    <p>Мин этаж</p>
                    <p><input name="min_floor" type="text"value=""/></p>
                    <p>Макс этаж</p>
                    <p><input name="max_floor" type="text" value="" placeholder="..."/></p>`;
            }
            if(selected.id == 2)
            {
                document.getElementById("estateopt").innerHTML = `
...
<body class="antialiased">
    ...
    <form action="{{route('create_req')}}" method="post">
        ...
        <div class="adress_card">
            ...
            <p>Номер квартиры</p>
            <p><input name="flat_num" type="number" value="{{ old('street_num') }}" placeholder="..."/></p>
